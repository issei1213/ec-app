...
const SetSizeArea = (props) => {
  ...
  const [index, setIndex] = useState(0),
        ...
        [quantitiy, setQuantity] = useState(0);
  ...
  const editSize = (index, size, quantitiy) => {
    setIndex(index)
    setSize(size)
      ...
      <TableContainer component={Paper}>
        ...
        <div>
          ...
          <TextInput 
            ...
            onChange={inputQuantity} rows={1} value={quantitiy} type={"number"}
          />
        </div>
        <IconButton className={classes.checkIcon} onClick={() => addSize(index, size, quantitiy)}>
          <CheckCircleIcon />
        </IconButton>
      </TableContainer>
    </div>
